...
class CaseClassesSpec extends FlatSpec with Matchers {
  "Case classes have an automatic" should "equals method that works" in {
  ...
  "Case classes have an automatic" should "hashcode method that works" in {
    case class Person(first: String, last: String)
  ...
  "Case classes can be created" should "in a convenient way" in {
  ...
  "Case classes have" should "a convenient toString method" in {
    case class Dog(name: String, breed: String)
    val d1 = Dog("Scooby", "Doberman")
    d1.toString should be("Dog(Scooby,Doberman)")
  }
  "Case classes have" should "automatic properties" in {
    case class Dog(name: String, breed: String)
  ...
  "Case classes can have" should "mutable properties" in {
  ...
  "safer alternatives for altering case classes" should "be" in {
  ...
  "Case classes can have default and named parameters" should "be" in {
  ...
  "Case classes can be disassembled to their constituent parts as a tuple" should "be" in {
    case class Person(first: String,
                      last: String,
                      age: Int = 0,
                      ssn: String = "")
  ...
  "Case classes" should "are Serializable" in {
