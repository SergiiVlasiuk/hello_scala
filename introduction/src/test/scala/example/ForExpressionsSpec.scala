...
class ForExpressionsSpec extends FlatSpec with Matchers {
  "for expressions can nest, with later generators varying more rapidly than earlier ones" should "be" in {
    val xValues = 1 to 4
    val yValues = 1 to 2
    val coordinates = for {
      x ← xValues
    ...
    coordinates(3) should be(2, 2)
  }
  "Using for we can make more readable code" should "be" in {
